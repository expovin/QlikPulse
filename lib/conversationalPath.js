...
module.exports  = {
    ...
    askForMoodHandleResp : {
        ...
        PostAction : function(skill, risposta){
            ...
            .then(trigram =>{
                log.trace("Get trigram : ",trigram," looking for country");
                var country = lookUpEmp.getCountry(trigram);
                log.info("Setting Response for Country : ",country);
                db.addNewHappyRank(country, Object.keys(risposta.submission)[0],risposta.submission[Object.keys(risposta.submission)[0]])
                .then( res =>{
