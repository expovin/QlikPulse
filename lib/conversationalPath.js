...
module.exports  = {
    ...
    askForMoodHandleResp : {
        ...
        PostAction : function(skill, risposta){
            ...
            .then(trigram =>{
                log.info("Setting Response for trigram : ",trigram);
                db.addNewHappyRank(lookUpEmp.getCountry(trigram), Object.keys(risposta.submission)[0],risposta.submission[Object.keys(risposta.submission)[0]])
                .then( res =>{
