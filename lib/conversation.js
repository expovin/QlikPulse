    ...
    handleResponse(response){
        ...
        return new Promise (function (fulfill, reject){
            ...
            if((response.callback_id === "askForHappinessHandleResp"))
            {
                ...
                log.debug("Interactive response: ",body);
                body.text="For results click <https://qtarchlabeu02.qliktech.com/sense/app/40ee02d2-e509-4b55-800c-501a76f93e61/sheet/df23b593-6a12-4edd-9297-9775ed11a2ac/state/analysis|here.> ";
